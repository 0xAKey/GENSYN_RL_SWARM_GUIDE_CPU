...
<p align="center">
  <img src="./images/banner.png" alt="Gensyn RL-Swarm Node Run Guide Banner" width="100%"/>
</p>
...
```bash
pip install --no-cache-dir   gensyn-genrl==0.1.11   "hivemind@git+https://github.com/gensyn-ai/hivemind@a0963c04a8019de61335a294663b5bec8e3536d"
```
